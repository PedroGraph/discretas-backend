...
export const mainRoutes = (app, {productModel, userModel, shoppingCartModel, orderModel, discountCodeModel, usedDiscountCodeModel, mercadoPagoModel, paymentModel}, redis) => {
